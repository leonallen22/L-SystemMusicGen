...
public class MusicAnalyzer
{
	...
	/**
	 * Performs a basic analysis of the MIDI files in the MIDIs folder. Based on the given MIDI files the method will generate a first-order Markov
	 * Chain which will give the likelihood of a note being chosen based on the previous note.
	 */
	...
	/**
	 * Performs an analysis of the MIDI files in the MIDIs folder. Based on the given MIDI files the method will generate a second-order Markov Chain
	 * which will give the likelihood of a note being chosen based on the previous two notes.
	 */
	public void analyzePitchSecondOrder()
	{
		Player player = new Player();
